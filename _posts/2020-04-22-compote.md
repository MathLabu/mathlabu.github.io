---
title: 'Compote: a set of tools to pre-calibrate and calibrate (multifocus) plenoptic cameras'
date: 2020-04-22
permalink: /posts/2020/04/compote/
...
Along with the [libpleno], we developed a set of tools to pre-calibrate and calibrate (multifocus) plenoptic cameras (e.g., a Raytrix R12), named COMPOTE (standing for Calibration Of Multi-focus PlenOpTic camEra) which is _available at <https://github.com/comsee-research/compote>_!

---
![banner-logo](/images/publications/banner-compote.png)
